using DancingMadness.Action;
using System;
using System.Text.RegularExpressions;
using static DancingMadness.Core.Timeline.Entry;
            ...
            while (true)
            {
                ...
                switch (m.Groups["id"].Value.ToLower())
                {
                    ...
                    case "_sincems":
                        ...
                        break;
                    case "_ttl":
                        if (a is DancingMadness.Action.Notification)
                        {
                            DancingMadness.Action.Notification n = (DancingMadness.Action.Notification)a;
