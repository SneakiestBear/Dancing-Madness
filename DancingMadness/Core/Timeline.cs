...
using static DancingMadness.Core.Timeline.Encounter;
...
namespace DancingMadness.Core
{
    ...
    public class Timeline
    {
        ...
        public class Reaction
        {
            ...
            [XmlElement(ElementName = "ChatMessage", Type = typeof(DancingMadness.Action.ChatMessage))]
            [XmlElement(ElementName = "Notification", Type = typeof(DancingMadness.Action.Notification))]
            [XmlElement(ElementName = "IngameCommand", Type = typeof(DancingMadness.Action.IngameCommand))]
