...
namespace DancingMadness.Language
{
    ...
    internal class English : Core.Language
    {
        ...
        public English(State st) : base(st)
        {
            ...
            AddEntry("Troubleshooting/Title", "Dancing Madness Troubleshooting");
            AddEntry("Troubleshooting/Intro", "If you have encountered a problem with Dancing Madness and something is not working as it should, please follow these instructions to collect some information and report the issue. This is most valuable when done within 30 minutes of the problem occurring, as details of the issue is still stored within memory.");
            AddEntry("Troubleshooting/Step1", "Press this button to generate a zip archive that contains your dalamud.log, your Dancing Madness configuration, and some Dancing Madness internal information from the last 30 minutes. This information will help greatly when trying to sort out the issue.");
            ...
            AddEntry("Troubleshooting/Step2", "To use that package, make note of the filename as you'll need it soon, and join the Dancing Madness Discord server by hitting the Discord button below, and follow the instructions pinned in channel #lemmy_questions.");
            ...
            AddEntry("Timelines/TimelineSelector/WindowTitle", "Dancing Madness timeline selector");
            AddEntry("Timelines/TimelineSelector/SelectionInfo", "By default, Dancing Madness will select the most recently edited timeline file it can find for a specific zone. You can add zone-specific overrides to make it always use the same timeline file. Please note that timeline reactions are generally tied to a specific timeline file.");
            ...
            #endregion
            #region <1.0.1.0
            AddEntry("Command/QuickToggleAutomarkers/On", "Dancing Madness: Automarkers are now enabled.");
            AddEntry("Command/QuickToggleAutomarkers/Off", "Dancing Madness: Automarkers are now disabled.");
            AddEntry("Command/QuickToggleOverlays/On", "Dancing Madness: Draws and overlays are now enabled.");
            AddEntry("Command/QuickToggleOverlays/Off", "Dancing Madness: Draws and overlays are now disabled.");
            AddEntry("Command/QuickToggleSound/On", "Dancing Madness: Sound features are now enabled.");
            AddEntry("Command/QuickToggleSound/Off", "Dancing Madness: Sound features are now disabled.");
            AddEntry("Command/QuickToggleHacks/On", "Dancing Madness: Hacks and game-altering features are now enabled.");
            AddEntry("Command/QuickToggleHacks/Off", "Dancing Madness: Hacks and game-altering features are now disabled.");
            AddEntry("Command/QuickToggleAutomation/On", "Dancing Madness: Automation features are now enabled.");
            AddEntry("Command/QuickToggleAutomation/Off", "Dancing Madness: Automation features are now disabled.");
            AddEntry("Command/AutomarkerSoft/On", "Dancing Madness: Client-side soft automarkers are now enabled.");
            AddEntry("Command/AutomarkerSoft/Off", "Dancing Madness: Client-side soft automarkers are now disabled.");
            ...
            AddEntry("Misc/OpenShortcut", "Open Dancing Madness");
            ...
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM", "(Forsaken) Tower/AoE automarker");
            ...
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/TowerOrder", "Tower order (which group takes each tower)");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/TowerOrder/AAABBBBA", "AAABBBBA");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/TowerOrder/ABBAABBA", "ABBAABBA");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/TowerOrder/AAAABBBB", "AAAABBBB");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Signs", "Marker configuration");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Signs/Stack1", "Stack 1");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Signs/Stack2", "Stack 2");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Signs/Cone1", "Cone 1");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Signs/Cone2", "Cone 2");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Signs/Cone3", "Cone 3 (lone cone, odd towers)");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Signs/Aoe1", "AoE 1");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Signs/Aoe2", "AoE 2");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Prio", "Priority configuration");
            AddEntry("Content/Ultimate/UltDancingMad/ForsakenAM/Simulate", "Simulate (debug): need a party of 8 in a duty. Click Forsaken, then each tower in order to send fake packets and watch the markers.");
