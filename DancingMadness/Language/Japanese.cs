...
namespace DancingMadness.Language
{
    ...
    internal class Japanese : Core.Language
    {
        ...
        public Japanese(State st) : base(st)
        {
            ...
            #endregion
            #region <1.0.1.0
            AddEntry("Command/QuickToggleAutomarkers/On", "Dancing Madness: オートマーカーを有効にしました。");
            AddEntry("Command/QuickToggleAutomarkers/Off", "Dancing Madness: オートマーカーを無効にしました。");
            AddEntry("Command/QuickToggleOverlays/On", "Dancing Madness: 描画とオーバーレイを有効にしました。");
            AddEntry("Command/QuickToggleOverlays/Off", "Dancing Madness: 描画とオーバーレイを無効にしました。");
            AddEntry("Command/QuickToggleSound/On", "Dancing Madness: サウンド機能を有効にしました。");
            AddEntry("Command/QuickToggleSound/Off", "Dancing Madness: サウンド機能を無効にしました。");
            AddEntry("Command/QuickToggleHacks/On", "Dancing Madness: ハックとゲーム改変機能を有効にしました。");
            AddEntry("Command/QuickToggleHacks/Off", "Dancing Madness: ハックとゲーム改変機能を無効にしました。");
            AddEntry("Command/QuickToggleAutomation/On", "Dancing Madness: 自動化機能を有効にしました。");
            AddEntry("Command/QuickToggleAutomation/Off", "Dancing Madness: 自動化機能を無効にしました。");
            AddEntry("Command/AutomarkerSoft/On", "Dancing Madness: クライアントサイドのソフトオートマーカーを有効にしました。");
            AddEntry("Command/AutomarkerSoft/Off", "Dancing Madness: クライアントサイドのソフトオートマーカーを無効にしました。");
