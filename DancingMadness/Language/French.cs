...
namespace DancingMadness.Language
{
    ...
    internal class French : Core.Language
    {
        ...
        public French(State st) : base(st)
        {
            ...
            AddEntry("Troubleshooting/Title", "Troubleshooting Dancing Madness");
            AddEntry("Troubleshooting/Intro", "Si vous rencontrez des problèmes avec Dancing Madness et que quelque chose ne fonctionne pas correctement, merci de suivre les instructions pour collecter des informations de base et reporter ce problème. C'est d'autant plus utile quand c'est réalisé dans les 30 premières minutes où le problème apparaît, car les détails du problème sont toujours en mémoire.");
            AddEntry("Troubleshooting/Step1", "Appuyez sur ce bouton pour générer un fichier ZIP qui contiendra votre dalamud.log, votre configuration Dancing Madness, et quelques informations internes à Dancing Madness des 30 dernières minutes. Ces informations aideront grandement à la résolution des problèmes.");
            ...
            AddEntry("Troubleshooting/Step2", "Pour utiliser ce fichier, notez le nom du fichier car vous en aurez besoin, et rejoigner le serveur Discord Dancing Madness en appuyant sur le bouton ci-dessous, et suivez les instructions épinglées au canal #lemmy_questions. (Anglais requis)");
