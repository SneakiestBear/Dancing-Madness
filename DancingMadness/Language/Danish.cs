...
namespace DancingMadness.Language
{
    ...
    internal class Danish : Core.Language
    {
        ...
        public Danish(State st) : base(st)
        {
            ...
            #endregion
            #region <1.0.1.0
            AddEntry("Command/QuickToggleAutomarkers/On", "Dancing Madness: Automarkører er nu aktiveret.");
            AddEntry("Command/QuickToggleAutomarkers/Off", "Dancing Madness: Automarkører er nu deaktiveret.");
            AddEntry("Command/QuickToggleOverlays/On", "Dancing Madness: Tegninger og overlejringer er nu aktiveret.");
            AddEntry("Command/QuickToggleOverlays/Off", "Dancing Madness: Tegninger og overlejringer er nu deaktiveret.");
            AddEntry("Command/QuickToggleSound/On", "Dancing Madness: Lyd funktioner er nu aktiveret.");
            AddEntry("Command/QuickToggleSound/Off", "Dancing Madness: Lyd funktioner er nu deaktiveret.");
            AddEntry("Command/QuickToggleHacks/On", "Dancing Madness: Hacks og spilændrende funktioner er nu aktiveret.");
            AddEntry("Command/QuickToggleHacks/Off", "Dancing Madness: Hacks og spilændrende funktioner er nu deaktiveret.");
            AddEntry("Command/QuickToggleAutomation/On", "Dancing Madness: Automatiseringsfunktioner er nu aktiveret.");
            AddEntry("Command/QuickToggleAutomation/Off", "Dancing Madness: Automatiseringsfunktioner er nu deaktiveret.");
            AddEntry("Command/AutomarkerSoft/On", "Dancing Madness: Klientbaserede soft automarkører er nu aktiveret.");
            AddEntry("Command/AutomarkerSoft/Off", "Dancing Madness: Klientbaserede soft automarkører er nu deaktiveret.");
            ...
            AddEntry("Misc/OpenShortcut", "Åben Dancing Madness");
