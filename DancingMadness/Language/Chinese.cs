...
namespace DancingMadness.Language
{
    ...
    internal class Chinese : Core.Language
    {
        ...
        public Chinese(State st) : base(st)
        {
            ...
            #endregion
            #region <1.0.1.0
            AddEntry("Command/QuickToggleAutomarkers/On", "Dancing Madness: 自动标记已启用。");
            AddEntry("Command/QuickToggleAutomarkers/Off", "Dancing Madness: 自动标记已关闭。");
            AddEntry("Command/QuickToggleOverlays/On", "Dancing Madness: 绘图和叠加层已启用。");
            AddEntry("Command/QuickToggleOverlays/Off", "Dancing Madness: 绘图和叠加层已关闭。");
            AddEntry("Command/QuickToggleSound/On", "Dancing Madness: 声音功能已启用。");
            AddEntry("Command/QuickToggleSound/Off", "Dancing Madness: 声音功能已关闭。");
            AddEntry("Command/QuickToggleHacks/On", "Dancing Madness: 破解和修改游戏的功能已启用。");
            AddEntry("Command/QuickToggleHacks/Off", "Dancing Madness: 破解和修改的游戏功能已关闭。");
            AddEntry("Command/QuickToggleAutomation/On", "Dancing Madness: 自动化功能已启用。");
            AddEntry("Command/QuickToggleAutomation/Off", "Dancing Madness: 自动化功能已关闭。");
            AddEntry("Command/AutomarkerSoft/On", "Dancing Madness: 客户端自动软标记已启用。");
            AddEntry("Command/AutomarkerSoft/Off", "Dancing Madness: 客户端自动软标记已关闭。");
            ...
            AddEntry("Misc/OpenShortcut", "打开 Dancing Madness");
