...
using static DancingMadness.Core.Timeline;
        ...
        public class TimelineRecorder : Core.ContentItem
        {
            ...
            private void StartRecording()
            {
                ...
                else
                {
                    ...
                    string filename = String.Format("DancingMadness_{0}_{1}.timeline.xml", _state.cs.TerritoryType, _startTime.ToString("yyyyMMdd_HHmmss"));
